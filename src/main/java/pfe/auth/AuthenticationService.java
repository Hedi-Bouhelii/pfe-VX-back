...
public class AuthenticationService {
  ...
  public AuthenticationResponse registerUser(InsuredRegisterRequest request) {
    ...
    agence.setAssure(Collections.singletonList(assure));
  ...
  public AuthenticationResponse authenticate(AuthenticationRequest request) {
    ...
    if (user.getRole().equals(Role.AGENCE)) {
      ...
      return new AuthenticationResponse (user.getId(), jwtToken,
              new AgenceDTO(agence.getId(),agence.getEmail(),agence.getName(),agence.getMatricule(),agence.getTel(), agence.getFile(),agence.getAddress(), agence.getStatus()),user.getRole());
    }
      ...
      revokeAllUserTokens(user);
      saveUserToken(user, jwtToken);
      return new AuthenticationResponse(user.getId(),jwtToken,new UserDTO(user.getEmail()),user.getRole());
    }
      ...
      saveUserToken(user, jwtToken);
      return new AuthenticationResponse(user.getId(),jwtToken,
              new AssureDTO(assure.getFirstName(),assure.getLastName(), assure.getEmail(), assure.getTel(), assure.getCin(), assure.getAddress(), assure.getAgence()),user.getRole());
    }
    else
      return AuthenticationResponse.builder()
